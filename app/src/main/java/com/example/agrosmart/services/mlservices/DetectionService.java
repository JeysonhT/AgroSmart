package com.example.agrosmart.services.mlservices;
...
public class DetectionService {
    ...
    public TensorImage bitmatToTensor(Bitmap bitmap){
        ...
        // se procesa la imagen para obtener el TensorImage final en formato float32
    ...
    public String processDetection(TensorImage tensorImage, Context context){
        ...
        try{
            ...
            // ejemplo con tensor image

            Bitmap testbitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.maizjpg);

            // creamos la salida, la cual tendra como valor el resultado que entregue el modelo
            AgroSmartMMLite.Outputs outputs = model.process(bitmatToTensor(testbitmap).getTensorBuffer());
